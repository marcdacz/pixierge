...
class TestAdminSeederTest {
    ...
    void runCreatesAdminWhenSeedUserIsMissing() {
        ...
        TestAdminSeeder seeder = new TestAdminSeeder(new PrefixPasswordEncoder(), userRepository, "AdminDacz", "secret");
    ...
    void runLeavesExistingAdminUntouched() {
        RecordingUserRepository userRepository = new RecordingUserRepository();
        userRepository.existingCredential = Optional.of(new UserRepository.LoginCredential(UUID.randomUUID(), "hash:old"));
        TestAdminSeeder seeder = new TestAdminSeeder(new PrefixPasswordEncoder(), userRepository, "AdminDacz", "secret");
