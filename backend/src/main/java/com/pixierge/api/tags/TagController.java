...
public class TagController {
  ...
  TagResponse create(
      @RequestBody CreateTagRequest request, @AuthenticationPrincipal AuthenticatedUser user) {
  ...
  @ResponseStatus(HttpStatus.NO_CONTENT)
  void assign(
      @RequestBody AssignAssetTagsRequest request,
      @AuthenticationPrincipal AuthenticatedUser user) {
  ...
  @ResponseStatus(HttpStatus.NO_CONTENT)
  void unassign(
      @RequestBody DeleteAssetTagsRequest request,
      @AuthenticationPrincipal AuthenticatedUser user) {
