...
public final class SchedulerConstants {
  ...
  public static final String CATALOG_EXPORT_CRON = "0 30 3 * * *";
  ...
  public static final String CATALOG_EXPORT_CONCURRENCY_KEY = "core:catalog-export";
  ...
  public static final int CATALOG_EXPORT_TIMEOUT_SECONDS = 10 * 60;
