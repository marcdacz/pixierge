...
public final class SchedulerConstants {
  ...
  public static final String DATABASE_BACKUP_CRON = "0 30 3 * * *";
  public static final String AUDIT_RETENTION_CRON = "0 15 3 * * *";
  ...
  public static final String FILE_ACTIVITY_RETENTION_CONCURRENCY_KEY =
      "core:file-activity-retention";
  public static final String DATABASE_BACKUP_CONCURRENCY_KEY = "core:database-backup";
  public static final String AUDIT_RETENTION_CONCURRENCY_KEY = "core:audit-retention";
  ...
  public static final int DATABASE_BACKUP_TIMEOUT_SECONDS = 10 * 60;
  public static final int AUDIT_RETENTION_TIMEOUT_SECONDS = 10 * 60;
