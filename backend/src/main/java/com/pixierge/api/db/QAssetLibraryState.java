...
public class QAssetLibraryState extends RelationalPathBase<QAssetLibraryState> {
  public static final QAssetLibraryState assetLibraryState = new QAssetLibraryState("asset_library_state");
  ...
  private void addMetadata() {
    ...
    addMetadata(privacy, ColumnMetadata.named("privacy").withIndex(3).ofType(Types.VARCHAR).notNull());
    addMetadata(updatedBy, ColumnMetadata.named("updated_by").withIndex(4).ofType(Types.OTHER).notNull());
