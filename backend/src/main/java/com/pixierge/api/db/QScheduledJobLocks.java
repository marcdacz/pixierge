...
public class QScheduledJobLocks extends RelationalPathBase<QScheduledJobLocks> {
  ...
  public static final QScheduledJobLocks scheduledJobLocks =
      new QScheduledJobLocks("scheduled_job_locks");
  ...
  public final DateTimePath<OffsetDateTime> acquiredAt =
      createDateTime("acquiredAt", OffsetDateTime.class);
  ...
  private void addMetadata() {
    addMetadata(
        concurrencyKey,
        ColumnMetadata.named("concurrency_key").withIndex(1).ofType(Types.VARCHAR).notNull());
    ...
    addMetadata(
        acquiredAt,
        ColumnMetadata.named("acquired_at")
            .withIndex(4)
