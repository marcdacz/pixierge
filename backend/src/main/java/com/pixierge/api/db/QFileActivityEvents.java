...
public class QFileActivityEvents extends RelationalPathBase<QFileActivityEvents> {
    public static final QFileActivityEvents fileActivityEvents = new QFileActivityEvents("file_activity_events");
    ...
    public final DateTimePath<OffsetDateTime> occurredAt = createDateTime("occurredAt", OffsetDateTime.class);
    ...
    public QFileActivityEvents(String variable) {
        ...
        addMetadata(occurredAt, ColumnMetadata.named("occurred_at").withIndex(5).ofType(Types.TIMESTAMP_WITH_TIMEZONE).notNull());
    ...
    @Override
    public SchemaAndTable getSchemaAndTable() { return new SchemaAndTable(null, "file_activity_events"); }
}
