...
public class QPasswordCredentials extends RelationalPathBase<QPasswordCredentials> {
  ...
  public static final QPasswordCredentials passwordCredentials =
      new QPasswordCredentials("password_credentials");
  ...
  private void addMetadata() {
    ...
    addMetadata(
        passwordHash,
        ColumnMetadata.named("password_hash").withIndex(2).ofType(Types.VARCHAR).notNull());
    addMetadata(
        createdAt,
