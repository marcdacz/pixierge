...
public class QAssetMetadata extends RelationalPathBase<QAssetMetadata> {
  ...
  public final DateTimePath<OffsetDateTime> capturedAt =
      createDateTime("capturedAt", OffsetDateTime.class);
  ...
  public final DateTimePath<OffsetDateTime> extractedAt =
      createDateTime("extractedAt", OffsetDateTime.class);
  ...
  public final NumberPath<Integer> metadataSchemaVersion =
      createNumber("metadataSchemaVersion", Integer.class);
  public final NumberPath<Long> metadataSourceFileSize =
      createNumber("metadataSourceFileSize", Long.class);
  public final DateTimePath<OffsetDateTime> metadataSourceModifiedAt =
      createDateTime("metadataSourceModifiedAt", OffsetDateTime.class);
  public final DateTimePath<OffsetDateTime> metadataExtractedAt =
      createDateTime("metadataExtractedAt", OffsetDateTime.class);
  ...
  public final NumberPath<Long> metadataExtractionDurationMs =
      createNumber("metadataExtractionDurationMs", Long.class);
  ...
  private void addMetadata() {
    ...
    addMetadata(
        capturedAt,
        ColumnMetadata.named("captured_at").withIndex(2).ofType(Types.TIMESTAMP_WITH_TIMEZONE));
    ...
    addMetadata(
        orientation, ColumnMetadata.named("orientation").withIndex(5).ofType(Types.INTEGER));
    addMetadata(
        fileExtension, ColumnMetadata.named("file_extension").withIndex(6).ofType(Types.VARCHAR));
    ...
    addMetadata(
        cameraModel, ColumnMetadata.named("camera_model").withIndex(9).ofType(Types.VARCHAR));
    addMetadata(
        sourceVersion,
        ColumnMetadata.named("source_version").withIndex(10).ofType(Types.VARCHAR).notNull());
    addMetadata(
        extractionStatus,
        ColumnMetadata.named("extraction_status").withIndex(11).ofType(Types.VARCHAR).notNull());
    addMetadata(
        extractedAt,
        ColumnMetadata.named("extracted_at").withIndex(12).ofType(Types.TIMESTAMP_WITH_TIMEZONE));
    addMetadata(
        errorMessage, ColumnMetadata.named("error_message").withIndex(13).ofType(Types.VARCHAR));
    addMetadata(
        metadataStatus,
        ColumnMetadata.named("metadata_status").withIndex(14).ofType(Types.VARCHAR));
    addMetadata(
        metadataExtractor,
        ColumnMetadata.named("metadata_extractor").withIndex(15).ofType(Types.VARCHAR));
    addMetadata(
        metadataExtractorVersion,
        ColumnMetadata.named("metadata_extractor_version").withIndex(16).ofType(Types.VARCHAR));
    addMetadata(
        metadataSchemaVersion,
        ColumnMetadata.named("metadata_schema_version").withIndex(17).ofType(Types.INTEGER));
    addMetadata(
        metadataSourceFileSize,
        ColumnMetadata.named("metadata_source_file_size").withIndex(18).ofType(Types.BIGINT));
    addMetadata(
        metadataSourceModifiedAt,
        ColumnMetadata.named("metadata_source_modified_at")
            .withIndex(19)
            .ofType(Types.TIMESTAMP_WITH_TIMEZONE));
    addMetadata(
        metadataExtractedAt,
        ColumnMetadata.named("metadata_extracted_at")
            .withIndex(20)
            .ofType(Types.TIMESTAMP_WITH_TIMEZONE));
    addMetadata(
        metadataErrorCode,
        ColumnMetadata.named("metadata_error_code").withIndex(21).ofType(Types.VARCHAR));
    addMetadata(
        metadataErrorMessage,
        ColumnMetadata.named("metadata_error_message").withIndex(22).ofType(Types.VARCHAR));
    addMetadata(lensModel, ColumnMetadata.named("lens_model").withIndex(23).ofType(Types.VARCHAR));
    addMetadata(
        focalLength, ColumnMetadata.named("focal_length").withIndex(24).ofType(Types.DOUBLE));
    addMetadata(aperture, ColumnMetadata.named("aperture").withIndex(25).ofType(Types.DOUBLE));
    addMetadata(
        exposureTime, ColumnMetadata.named("exposure_time").withIndex(26).ofType(Types.VARCHAR));
    ...
    addMetadata(
        description, ColumnMetadata.named("description").withIndex(31).ofType(Types.VARCHAR));
    ...
    addMetadata(
        displayRotation,
        ColumnMetadata.named("display_rotation").withIndex(34).ofType(Types.INTEGER));
    addMetadata(container, ColumnMetadata.named("container").withIndex(35).ofType(Types.VARCHAR));
    addMetadata(
        videoCodec, ColumnMetadata.named("video_codec").withIndex(36).ofType(Types.VARCHAR));
    addMetadata(
        audioCodec, ColumnMetadata.named("audio_codec").withIndex(37).ofType(Types.VARCHAR));
    ...
    addMetadata(
        metadataExtractionDurationMs,
        ColumnMetadata.named("metadata_extraction_duration_ms").withIndex(41).ofType(Types.BIGINT));
  }
