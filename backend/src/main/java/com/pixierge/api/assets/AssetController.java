...
public class AssetController {
  ...
  public AssetController(
      AssetService assetService, MetadataEnrichmentService metadataEnrichmentService) {
  ...
  AssetDetailResponse getAsset(
      @AuthenticationPrincipal AuthenticatedUser user, @PathVariable UUID assetId) {
